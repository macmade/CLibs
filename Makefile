...
_FILES_SRC_LA          = $(subst $(EXT_CODE),$(EXT_LIB_ARCHIVE),$(_FILES_SRC_REL))
_FILES_SRC_LA_BUILD    = $(addprefix $(DIR_BUILD),$(_FILES_SRC_LA))
...
$(DIR_BUILD)%$(EXT_LIB_OBJECT): %$(EXT_CODE) %$(EXT_HEADERS)
